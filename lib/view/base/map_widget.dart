...
class _MapWidgetState extends State<MapWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(120)):  CustomAppBar(title: getTranslated('delivery_address', context)),
